...
function CommentList({ id, userId }) {
  ...
  // Link
  const contentChek =
    "http://localhost/myboard_serverl/Board/Post_ReadComment.php";
  const postCommentLink =
    "http://localhost/myboard_serverl/Board/Post_WriteComment.php";
  const postLikeLink =
    "http://localhost/myboard_serverl/Board/Post_CommentLike.php";
