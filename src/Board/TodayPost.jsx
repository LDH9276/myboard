                            ...
                            <Link to={`/read/${item.id}`} className="today-list-item">
                                ...
                                <div className="today-item-bottom_wrap">
                                    ...
                                    <p className="today-badge-wrap">
                                        <span className="today-badge-like">
                                            <img src={`${process.env.PUBLIC_URL}/btn/like.svg`} alt="댓글수" className="today-item-icon" />
                                            {item.total_like}
                                        </span>
                                        <span className="today-badge-like">
                                            <img src={`${process.env.PUBLIC_URL}/btn/comment.svg`} alt="댓글수" className="today-item-icon" />
                                            {item.comment_count}
                                        </span>
                                    </p>
                                </div>
