...
function List({boardId, postCategory, boardCate, autoRefresh}) {
  ...
  const pagination = "http://leedh9276.dothome.co.kr/board_api/Board/Post_Pagination.php";
  const listCheck  = "http://leedh9276.dothome.co.kr/board_api/Board/Post_List.php";
