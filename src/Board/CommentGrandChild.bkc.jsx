...
function CommentGrandChild({ commentId, children, id, userId, handleModify, handleDelete, handelAnswer, handleLikeAction }) {
                            ...
                            <div className="comment-left-wrap">
                                ...
                                {userId !== "" ? (
                                    <div className="comment-btn-wrap">
                                        <button onClick={() => handelAnswer(commentId, child.id)} className="comment-reply-btn">
                                            답글
                                        </button>
                                        {userId === child.writer ? (
