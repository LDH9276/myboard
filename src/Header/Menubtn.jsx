    ...
    return (
        <div className="flex flex-col justify-center items-center w-1/3 shadow-xl z-40 relative bg-base-100 border-primary border-4 sm:w-full sm:h-full md:w-1/3 md:h-auto">
            <ul className="w-full px-4 box-border sm:flex justify-between py-4 sm:mt-0 md:block md:translate-y-0">
                <li className="w-full">
                    <button className="flex justify-center items-center flex-col py-2 mt-2 border-b-[1px] mb-4 text-center w-full box-border sm:mb-0 sm:gap-2 sm:border-b-0 sm:mt-0 md:mt-2 md:mb-4" onClick={() => navigate('/')}>
                ...
                <li className="w-full">
                    <button className="flex justify-center items-center flex-col py-2 border-b-[1px] mb-4 text-center w-full box-border  sm:mb-0 sm:gap-2 sm:border-none md:border-b-[1px] md:mb-4" onClick={() => dispatch(userBtn("list"))}>
                        <img src={`${process.env.PUBLIC_URL}/btn/pop.svg`}  className="mb-2 sm:w-5 sm:mb-0 sm:h-6 md:w-full md:h-5" alt="찾아보기" />
                        <span className="text-xs font-bold text-[#333] sm:text-sm">인기게시판</span>
                    </button>
                </li>
                <li className="w-full">
                    <button className="flex justify-center items-center flex-col py-2 border-b-[1px] mb-4 text-center w-full box-border sm:mb-0 sm:gap-2 sm:border-none md:border-b-[1px] md:mb-4" onClick={() => dispatch(userBtn("main"))}>
                ...
                <li className="w-full">
                    <button className="flex justify-center items-center flex-col py-2 border-b-[1px] mb-4 text-center w-full box-border  sm:mb-0 sm:gap-2 sm:border-none md:border-b-[1px] md:mb-4" onClick={() => dispatch(userBtn("search"))}>
                ...
                <li className="w-full">
                <button className="flex justify-center items-center flex-col py-2 mb-4 text-center w-full box-border sm:mb-0 sm:gap-2 sm:border-none md:mb-4">
